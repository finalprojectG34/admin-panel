...
const FirebaseRegister = (props) => {
    ...
    // useEffect(() => {
    //     setFirebaseID(match.params.firebaseID);
    //     setPhoneNumber(match.params.phoneNumber);
    ...
    const handleSubmit = (e) => {
        ...
        //     }
        // }).then(res => {
        //     setSessionToken(res.data['ownerSignUp']['accessToken']);
        //     setRolesData(res.data['ownerSignUp']['roles']);
        // });
    };

    // if (!isLoggedIn && !firebaseID_auth) {
